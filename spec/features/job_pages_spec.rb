...
RSpec.describe 'Job Pages' do
  ...
  before :each do
    ...
    @job2 = @company1.jobs.create!(title: 'Developer Too', 
  ...
  context '/jobs/new' do
    describe 'A user visits the new job page' do
      it 'they can create a new job' do
        ...
        select "#{new_loi} of 5", from: 'job[level_pf_interest]'
  ...
  context '/jobs/:id/edit' do
    describe 'A user visits the edit page for a job' do
      xit 'they should be able to update a job' do
        visit edit_job_path(@company1, @job1)
  ...
  context 'User visits' do
    xit 'they should be able to delete a job' do
      visit jobs_path
